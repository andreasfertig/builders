...
cmake -G "Ninja" -DCMAKE_OSX_DEPLOYMENT_TARGET="10.15" -DCMAKE_INSTALL_PREFIX=${INSTALL_PATH} -DCMAKE_BUILD_TYPE=MinSizeRel -DLLVM_INCLUDE_EXAMPLES=0 -DLLVM_INCLUDE_TESTS=0 -DLLVM_ENABLE_ZSTD=On -DLLVM_ENABLE_PROJECTS="clang" -DLLVM_ENABLE_RUNTIMES="compiler-rt;libcxx;libcxxabi;libunwind" -DCMAKE_CXX_STANDARD=20 -DLLVM_TARGETS_TO_BUILD=X86 ${GIT_REPO}/llvm
